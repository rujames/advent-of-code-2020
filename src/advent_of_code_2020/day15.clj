...
Your puzzle input is 1,0,18,10,19,6.
"

(def input '(6 19 10 18 0 1))

(defn next [spoken]
  (cons
   (if-let [previous-index (some #(if (= (first spoken) (second %)) (first %)) (map-indexed (fn [i x] [(inc i) x]) (rest spoken)))]
     previous-index
     0)
   spoken))
